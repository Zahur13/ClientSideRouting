              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">hello@routeapp.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">123 Main St, Suite 100<br />San Francisco, CA 94105</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200 flex items-center justify-center group"
                  >
                    Send Message
